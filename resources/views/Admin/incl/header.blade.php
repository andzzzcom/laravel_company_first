                    ...
                    <div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="text-center user-profile-section">                            
                            <div class="media mx-auto">
								<div class="media-body">
									@if(!is_null(Session::get("avatar_admin")) && file_exists(('assets_admin/assets/theme1/images/'.Session::get("avatar_admin"))))
										<img src="{{ asset('assets/theme1/images/'.Session::get('avatar_admin')) }}" style="height:90px;width:auto" class="img-fluid mr-2 mt-10">
									@else
										<img src="{{ asset('assets/theme1/images/person.png') }}" style="height:90px;width:auto" class="img-fluid mr-2 mt-10">
									@endif
                                </div>
                            </div>                   
                            <div class="media mx-auto">
