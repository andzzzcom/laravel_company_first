					...
					<div class="statbox widget box box-shadow">
						...
						<div class="widget-content widget-content-area">
							@if($errors->any())
								...
								@endforeach
							@endif
							<form method="post" enctype="multipart/form-data" action="{{ url('admin/project/delete') }}">
								@csrf
								...
								<div class="input-group mb-3">
									...
									<select readonly id="categoryProject" name="id_category" class="form-control">
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $project[0]->name }}" type="text" class="form-control" name="name" id="nameProject" placeholder="Insert Project Name">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $project[0]->start_date }}" type="date" class="form-control" name="start_date" id="startDateProject" placeholder="Insert Start Date Project">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $project[0]->duration }}" type="number" min="1" step="1" class="form-control" name="duration" id="durationProject" placeholder="Insert Duration Project">
								</div>
								...
								<div class="input-group mb-3">
									...
									<select readonly id="statusProject" name="status_active" class="form-control">
