		...
		<div class="layout-px-spacing">
			...
			<nav class="breadcrumb-one layout-top-spacing" aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item">
						<a href="{{ url('admin/project') }}">Projects List</a>
					</li>
					...
					<div class="statbox widget box box-shadow">
						...
						<div class="widget-content widget-content-area">
							@if($errors->any())
								...
								@endforeach
							@endif
							<form method="post" enctype="multipart/form-data" action="{{ url('admin/project/add') }}">
								@csrf
								...
								<div class="input-group mb-3">
									...
									<input required value="{{ old('name') }}" type="text" class="form-control" name="name" id="nameProject" placeholder="Insert Project Name">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input required value="{{ old('start_date') }}" type="date" class="form-control" name="start_date" id="startDateProject" placeholder="Insert Start Date Project">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input required value="{{ old('duration') }}" type="number" min="1" step="1" class="form-control" name="duration" id="durationProject" placeholder="Insert Duration Project">
								</div>
