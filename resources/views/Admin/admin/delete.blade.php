						...
						<div class="widget-content widget-content-area">
							...
							<form method="post" enctype="multipart/form-data" action="{{ url('admin/admin/delete') }}">
								...
								<div class="input-group mb-3">
									...
									<input required readonly value="{{ $admin[0]['email'] }}" type="email" class="form-control" id="emailAdmin">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $admin[0]['name'] }}" type="text" class="form-control" id="nameAdmin" placeholder="Insert Name Admin">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $admin[0]['address'] }}" type="text" class="form-control" id="addressAdmin" placeholder="Insert Address Admin">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $admin[0]['phone'] }}" type="text" class="form-control" id="phoneAdmin" placeholder="Insert Phone Admin">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly type="text" value="{{ $admin[0]['born_place'] }}"  class="form-control" name="born_place" id="bornPlaceAdmin" placeholder="Insert Born Place Admin">
								</div>
								
								<label for="avatarAdmin">Avatar</label>
								<br>
								@if(!is_null($admin[0]['avatar']) && file_exists(('assets/theme1/images/admin/'.$admin[0]['avatar'])))
									<img src="{{ asset('assets/theme1/images/admin/'.$admin[0]['avatar']) }}" style="height:50px;width:auto" class="mt-10 img-responsive">
								@else
								...
								<div class="input-group mb-3">
									...
									<select readonly id="roleAdmin" name="role" class="form-control">
										@foreach($role as $r)
								...
								<div class="input-group mb-3">
									...
									<select readonly id="genderAdmin" class="form-control">
								...
								<div class="input-group mb-3">
									...
									<select readonly id="statusAdmin" class="form-control">
