						...
						<div class="widget-content widget-content-area">
							...
							<form method="post" enctype="multipart/form-data" action="{{ url('admin/employee/delete') }}">
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $employee[0]->name }}" type="text" class="form-control" name="name" id="nameEmployee" placeholder="Insert Employee Name">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $employee[0]->email }}" type="email" class="form-control" name="email" id="emailEmployee" placeholder="Insert Employee Email">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $employee[0]->phone }}" type="text" class="form-control" name="phone" id="phoneEmployee" placeholder="Insert Phone Employee">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $employee[0]->born_date }}" type="date" class="form-control" name="born_date" id="bornDateEmployee" placeholder="Insert Born Date Employee">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $employee[0]->address }}" type="text" class="form-control" name="address" id="addressEmployee" placeholder="Insert Address Employee">
								</div>
								...
								<div class="input-group mb-3">
									...
									<select readonly id="genderEmployee" name="gender" class="form-control">
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $employee[0]->salary }}" type="number" class="form-control" name="salary" id="salaryEmployee" placeholder="Insert Salary Employee">
								</div>
								...
								<div class="input-group mb-3">
									...
									<select readonly id="statusEmployee" name="status_active" class="form-control">
