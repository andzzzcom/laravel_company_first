						...
						<div class="widget-content widget-content-area">
							...
							<form method="post" enctype="multipart/form-data" action="{{ url('admin/designation/delete') }}">
								...
								<div class="input-group mb-3">
									...
									<select readonly id="nameDepartment" name="id_department" class="form-control">
								...
								<div class="input-group mb-3">
									...
									<input readonly value="{{ $designation[0]['name'] }}" type="text" class="form-control" name="name" id="nameDesignation" placeholder="Insert Designation Name">
								</div>
								...
								<div class="input-group mb-3">
									...
									<select readonly id="statusDesignation" name="status_active" class="form-control">
